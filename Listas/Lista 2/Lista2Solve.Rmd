...
$$\Omega = \{(x_1,\dots,x_{6}): x_i \in \{1,...,10\},\;i = [1,...,6]\}$$

$$|\Omega| = 10.10.10...10=10^6$$

$$A = \{(x_1,\dots,x_{6}): x_i \in \{1,...,10\},\;i = [1,...,6],\; x_i \neq x_j,\; \forall\;i\neq j\}$$

$$|A| = \frac{10!}{(\underbrace{10-6}_{\substack{\text{10 paradas } \\ \text{com base em} \\ \text{6 pessoas sem} \\ \text{repetir}}})!}=\frac{10!}{4!}=10.9.8.7.6.5=A_{10,6}$$
