...
$$\Omega = \{[\omega_1,\dots,\omega_{n-1}]: \omega_i \in S,\;i = 1,...,n-1,\; \omega_i \neq \omega_j,\; p/i \neq j\}$$

$|\Omega| = {b+r \choose n-1}$

$A_i = \{ \text{Tirar bola preta na i-ésima extração}\}$

$|A_i| = {b \choose 1}\frac{1}{b}$

$A^c_1 \cap A^c_2 \cap ... \cap A^c_{n-1} \cap A_n$

$$\begin{aligned}
P(A^c_1 \cap A^c_2 \cap ... \cap A^c_{n-1} \cap A_n) &= P(A^c_1).P(A^c_2|A^c_1)...P(A^c_{n-1}|A^c_1\cap...\cap A^c_{n-2}).P(A_{n})\\
&=\frac{{r \choose n-1}\frac{1}{r}.\frac{1}{r-1}.\frac{1}{r-2}...\frac{1}{r-(n-1)}.{b \choose 1}\frac{1}{b}}{{r+b \choose n-1}} \\
\end{aligned}$$
...
```{r}
choose(13,4)*choose(4,2)*choose(4,1)*choose(4,1)*choose(4,1)*4
choose(12,3)*choose(4,2)*4^3*13
```
